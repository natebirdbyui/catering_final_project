import{g as m,i as p,d as y,u as E,c as b,a as f,b as v,e as g}from"./cart-CsStHKWq.js";import"./cartAnimation-BuOtR5Oh.js";console.log("mobileCart.js loaded");function L(){const c=document.querySelector(".mobile-cart-drawer"),n=document.getElementById("open-cart"),e=document.getElementById("close-cart"),a=document.getElementById("mobile-checkout");a&&a.addEventListener("click",()=>{window.location.href="../cart/cart.html"}),!(!c||!n||!e)&&(n.addEventListener("click",()=>{c.classList.add("open")}),e.addEventListener("click",()=>{c.classList.remove("open")}),window.addEventListener("cart:update",o=>{r(o.detail?.totals)}),r())}function r(c={}){const n=m(),e=document.getElementById("mobile-cart-items"),a=document.getElementById("mobile-tax"),o=document.getElementById("mobile-total"),i=document.getElementById("mobile-count");if(!e)return;if(n.length===0){e.innerHTML="<p>Your order is empty.</p>",a&&(a.textContent="0.00"),o&&(o.textContent="0.00"),i&&(i.textContent="0");return}e.innerHTML=n.map(t=>`
